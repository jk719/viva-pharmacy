...
export async function sendAdminWelcomeEmail(to, { verificationToken, tempPassword }) {
    try {
        ...
        const emailContent = `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                ...
                <p>You have been invited to join as a manager.</p>
                ...
                <p>${verificationUrl}</p>
                <p>After verifying your email, you can log in with:</p>
                <ul>
                    <li>Email: ${to}</li>
