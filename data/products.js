...
const products = [
  ...
  { 
    ...
    price: 2.99, 
    description: 'PediaSure Grow & Gain Kids Nutritional Shake is specially designed to help kids grow and gain weight. Packed with protein, vitamins, and minerals in a delicious vanilla flavor.', 
  ...
  { 
    ...
    price: 2.99, 
    description: 'Fuel your child\\\'s growth with PediaSure Grow & Gain Kids Nutritional Shake in delicious chocolate flavor. Each serving provides complete, balanced nutrition to support healthy development.', 
    category: 'Nutritional Shakes', 
    isFeatured: true 
  },
  { 
  ...
  { 
    ...
    price: 19.99, 
    description: 'Relieve your child\\\'s allergy symptoms with Children\\\'s Flonase Sensimist. This gentle, scent-free nasal spray provides 24-hour relief from indoor and outdoor allergies.', 
    category: 'Allergy Relief', 
    isFeatured: true 
  },
  { 
  ...
  { 
    ...
    price: 11.99, 
    description: 'Get a peaceful night\\\'s sleep with Zarbee\\\'s Children\\\'s Cough & Mucus Night Syrup. Made with natural ingredients, this syrup helps relieve nighttime cough and congestion.', 
  ...
  { 
    ...
    price: 11.99, 
    description: 'Zarbee\\\'s Children\\\'s Cough & Mucus Day Syrup is a delicious and effective way to soothe your child\\\'s cough and congestion. Made with natural ingredients, this syrup helps relieve daytime cough and congestion.', 
    category: 'Cough & Congestion Relief', 
    isFeatured: true 
  },
  { 
    ...
    price: 13.99, 
    description: 'Relieve your child\\\'s cough and congestion with HYLAND\\\'S KIDS Mucus Cough NT GRP LIQ 4OZ. This liquid medicine is specially formulated to help relieve cough and congestion in children. Trust HYLAND\\\'S for effective relief.', 
    category: 'Cough & Congestion Relief', 
    isFeatured: true 
  },
  { 
    ...
    price: 9.99, 
    description: 'Support your child\\\'s respiratory health with Hyland\\\'s Kids Cough & Mucus Daytime Grape Liquid 4o. This liquid medicine is specially formulated to help relieve cough and congestion in children. Trust Hyland\\\'s for effective relief.', 
    category: 'Cough & Congestion Relief', 
    isFeatured: true 
  },
  { 
  ...
  { 
    ...
    price: 7.99, 
    description: 'Don\\\'t let motion sickness ruin your day! Dramamine All Day Less Drowsy Motion Sickness Relief 8ct provides effective relief from motion sickness, helping you stay comfortable and focused throughout your journey. Trust Dramamine for reliable and effective motion sickness relief.', 
  ...
  { 
    ...
    price: 11.99, 
    description: 'Relieve your child\\\'s pain and fever with Children\\\'s Tylenol Pain & Fever 160mg Acetaminophen Bubblegum Chewable Tablets. This chewable tablet is made with the highest quality acetaminophen to provide effective pain and fever relief. Trust Children\\\'s Tylenol for trusted relief.', 
    category: 'Pain Relief', 
    isFeatured: true 
  },
  { 
    ...
    price: 11.99, 
    description: 'Stay ahead of your child\\\'s cold and cough symptoms with Children\\\'s Tylenol Cold & Cough Runny Nose Oral Suspension Grape 4oz. This oral suspension is made with the highest quality acetaminophen and dextromethorphan to provide effective relief from cold and cough symptoms. Trust Children\\\'s Tylenol for trusted relief.', 
    category: 'Cold & Flu Relief', 
    isFeatured: true 
  },
  { 
  ...
  { 
    ...
    price: 11.99, 
    description: 'Take care of your child\\\'s digestive health with Pepto Bismol Kids Gummies 24ct. These easy-to-use gummies are made with the highest quality ingredients to provide effective relief from stomach discomfort. Trust Pepto Bismol for trusted relief.', 
    category: 'Digestive Relief', 
    isFeatured: true 
  },
  { 
  ...
  { 
    ...
    price: 4.99, 
    description: 'Soothe your sore throat with Cepacol\\\'s Extra Strength Sore Throat Honey Lemon Lozenges. These lozenges are made with pure honey and natural lemon flavor to provide fast and effective relief from sore throat symptoms. Trust Cepacol for trusted relief.', 
  ...
  { 
    ...
    price: 15.99, 
    description: 'Relieve your child\\\'s cold and flu symptoms with Children\\\'s Mucinex Stuffy Nose Chest Congestion Very Berry Flavor 4oz. This liquid medicine is specially formulated to help relieve cold and flu symptoms in children. Trust Children\\\'s Mucinex for trusted relief.', 
    category: 'Cold & Flu Relief', 
    isFeatured: true 
  },
  { 
